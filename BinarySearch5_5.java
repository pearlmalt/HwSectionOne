...
public class BinarySearch5_5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(intKey + "found at index = " +Arrays.binaraySearch(intArr,charKey));
		System.out.println(doubleKey + "found at index = " Arrays.binaraySearch(doubleArr,doubleKey));
